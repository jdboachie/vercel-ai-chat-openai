...
const Page = () => {
  return (
    <div className='w-screen h-screen box-gradient overflow-hidden flex flex-col space-y-6 items-center justify-center'>
      ...
      <p className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 via-neutral-400 to-neutral-600">
        <span>Developed by </span>
        <Link
          href={'https://www.read.cv/judeboachie'}
          className='underline font-semibold text-neutral-500 underline-offset-8 decoration-dotted'
        >
          Jude Boachie
        </Link>
      </p>
      <div className="flex space-x-4">
        <Button variant={'outline'} className='px-8 py-5 rounded-full hover:cursor-not-allowed bg-white/70 backdrop-blur-lg' >
          <p className="">Login</p>
